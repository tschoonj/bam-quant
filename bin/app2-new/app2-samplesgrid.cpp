...
App2::SamplesGrid::SamplesGrid(App2::Assistant *assistant_arg, App2::EnergiesGrid *grid_arg, Gtk::TreeRowReference ref_arg) :
	...
	oss << "Select at least two AXIL results files of samples with unknown composition that were recorded at " 
	    << energy
	    << "keV. The files that are selected on the other sample pages should correspond to the samples selected here, respecting the order.";
